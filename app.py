...
class App(tk.Tk):
    def __init__(self):
        ...
        ttk.Radiobutton(ctrl, text="Proposal Page", variable=self.price_source, value="proposal").grid(
            row=1, column=1, sticky="w"
        )
        ttk.Radiobutton(ctrl, text="Detail (Civil/Elect/Structural)", variable=self.price_source, value="detail").grid(
